...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.sdk_eums.SdkEumsPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin sdk_eums, com.example.sdk_eums.SdkEumsPlugin", e);
    }
    try {
      flutterEngine.getPlugins().add(new com.example.sdk_eums_c.SdkEums_cPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin sdk_eums_c, com.example.sdk_eums_c.SdkEums_cPlugin", e);
    }
    try {
