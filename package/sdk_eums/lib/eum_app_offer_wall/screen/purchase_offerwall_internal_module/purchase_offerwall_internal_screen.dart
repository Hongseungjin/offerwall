...
class PurchaseOfferwallInternalScreen extends StatefulWidget {
  ...
  @override
  State<PurchaseOfferwallInternalScreen> createState() =>
      _PurchaseOfferwallInternalScreenState();
}

class _PurchaseOfferwallInternalScreenState
    extends State<PurchaseOfferwallInternalScreen> {
  final GlobalKey<State<StatefulWidget>> globalKey =
      GlobalKey<State<StatefulWidget>>();
  InAppWebViewController? webView;

  String myurl =
      "https://indend.welfaredream.com/front/goods/content.asp?guid=216773";
      ...
      child: MultiBlocListener(listeners: [
        BlocListener<PurchaseOfferwallInternalBloc, PuschaseOffWallState>(
          listenWhen: (previous, current) =>
              previous.puschaseOfferWallInternalStatus !=
              current.puschaseOfferWallInternalStatus,
            ...
            try {
              if (html.contains('주문접수가<br>완료되었습니다.')) {
                ...
                globalKey.currentContext
                    ?.read<PurchaseOfferwallInternalBloc>()
                    .add(PuschaseOffWall(xId: widget.data['idx'], lang: lang));
                print("success");
