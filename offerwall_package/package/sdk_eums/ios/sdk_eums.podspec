...
A new Flutter plugin project.
  ...
  # s.pod_target_xcconfig = { 'OTHER_LDFLAGS' => '-framework TnkRwdSdk -framework IveOfferwallFramework ', 'DEFINES_MODULE' => 'YES', 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386, arm64' }
  # s.preserve_paths = 'libs/TnkRwdSdk.xcframework', 'libs/IveOfferwallFramework.framework'
  # s.vendored_frameworks = 'libs/TnkRwdSdk.xcframework', 'libs/IveOfferwallFramework.framework'
